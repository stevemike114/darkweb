...
function updateCartTotal() {
    ...
    var discountTitle = document.getElementById('titlelogs3');
    
    if(localStorage.getItem('acc-balance')) {
        discountTitle.innerHTML = `Account Balance: $${localStorage.getItem('acc-balance')}`;
    } else {
        discountTitle.innerHTML = `Account Balance: $0`;
    }
